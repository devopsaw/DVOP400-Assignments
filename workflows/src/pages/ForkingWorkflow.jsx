        ...
        <aside className="col-12 col-md-4">
          <nav className="toc">
            ...
            <ol className="mt-2 mb-0 ps-3">
              ...
              <li><a href="#visual">Example visuals</a></li>
        ...
        <article className="col-12 col-md-8">
          ...
          <section id="workflow-steps" className="section">
            ...
            <ol>
              ...
              <li><strong>Push</strong> your branch to your fork.</li>
              <li>
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  >DEV: Simplifying the git forking workflow</a
                >
              </li>
              <li>
                <a href="https://gitprotect.io/blog/git-forking-workflow/"
                  >GitProtect: Git Forking Workflow</a
                >
              </li>
              <li>
                <a
